...
public class Constants {
    ...
    public static final String  DEFAULT_REMOTING_SERIALIZATION     = "hessian";
    ...
    public static final String URL_PARAM_LOADBANLANCE="loadBanlance";
    public static final String URL_PARAM_SRRIALIZE="serialize";
    public static final String URL_PARAM_TIMEOUT="timeout";
    public static final String URL_PARAM_VERSION="version";
    
	public final static AttributeKey<Class> classKey = AttributeKey.valueOf("netty.class");
